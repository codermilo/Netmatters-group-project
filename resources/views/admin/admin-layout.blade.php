...
<body class="bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-200 font-sans">
    <div class="flex flex-col md:flex-row min-h-screen">
        ...
        <!-- Mobile Topbar -->
        <header class="flex justify-between items-center bg-white dark:bg-gray-800 px-4 py-3 shadow md:hidden">
        ...
        <!-- Sidebar -->
        <aside id="sidebar"
            class="fixed md:static top-0 left-0 z-40 h-full w-64 transform -translate-x-full md:translate-x-0 md:flex bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 p-6 flex-col justify-between transition-transform duration-300 ease-in-out">
            <div>
