<footer class="bg-[#F5F5F7]">
  <div class="lg:container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[1fr_1.25fr_1fr]">

    <div class="hidden lg:flex flex-col justify-between p-2 border-t-2">
    ...
    <div class="hidden md:flex justify-items-center flex-col items-center gap-2 md:border-r-2 lg:border-l-2 border-t-2">
    ...
    <div class="flex justify-items-center flex-col items-center gap-5 border-t-2 py-10">
